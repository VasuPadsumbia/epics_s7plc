...
epicsShareExtern dset *pvar_dset_devAaiSoft, *pvar_dset_s7plcAai,
    *pvar_dset_devAaoSoft, *pvar_dset_s7plcAao, *pvar_dset_devAiSoft,
    ...
    *pvar_dset_devAoSoftCallback, *pvar_dset_s7plcAo,
    ...
    *pvar_dset_s7plcStringout, *pvar_dset_s7plcAddr, *pvar_dset_devSASoft,
    *pvar_dset_devWfSoft, *pvar_dset_s7plcWaveform;

static const char * const deviceSupportNames[] = {
    "devAaiSoft", "s7plcAai", "devAaoSoft", "s7plcAao", "devAiSoft",
    "devAiSoftRaw", "devAiSoftCallback", "devTimestampAI",
    "devAiGeneralTime", "s7plcAi", "devAoSoft", "devAoSoftRaw",
    "devAoSoftCallback", "s7plcAo", "devBiSoft", "devBiSoftRaw",
    "devBiSoftCallback", "devBiDbState", "s7plcBi", "s7plcStat",
    "devBoSoft", "devBoSoftRaw", "devBoSoftCallback", "devBoGeneralTime",
    "devBoDbState", "s7plcBo", "devCalcoutSoft", "devCalcoutSoftCallback",
    "s7plcCalcout", "devEventSoft", "devHistogramSoft", "devLiSoft",
    "devLiSoftCallback", "devLiGeneralTime", "s7plcLongin", "devLoSoft",
    "devLoSoftCallback", "s7plcLongout", "devLsiSoft", "devLsiEnviron",
    "devLsoSoft", "devLsoSoftCallback", "devLsoStdio", "devMbbiSoft",
    "devMbbiSoftRaw", "devMbbiSoftCallback", "s7plcMbbi",
    ...
    "devSoStdio", "s7plcStringout", "s7plcAddr", "devSASoft", "devWfSoft",
    "s7plcWaveform"
};

static const dset * const devsl[] = {
    pvar_dset_devAaiSoft, pvar_dset_s7plcAai, pvar_dset_devAaoSoft,
    pvar_dset_s7plcAao, pvar_dset_devAiSoft, pvar_dset_devAiSoftRaw,
    ...
    pvar_dset_s7plcBi, pvar_dset_s7plcStat, pvar_dset_devBoSoft,
    pvar_dset_devBoSoftRaw, pvar_dset_devBoSoftCallback,
    pvar_dset_devBoGeneralTime, pvar_dset_devBoDbState, pvar_dset_s7plcBo,
    pvar_dset_devCalcoutSoft, pvar_dset_devCalcoutSoftCallback,
    pvar_dset_s7plcCalcout, pvar_dset_devEventSoft,
    pvar_dset_devHistogramSoft, pvar_dset_devLiSoft,
    pvar_dset_devLiSoftCallback, pvar_dset_devLiGeneralTime,
    pvar_dset_s7plcLongin, pvar_dset_devLoSoft,
    pvar_dset_devLoSoftCallback, pvar_dset_s7plcLongout,
...
static const iocshFuncDef rrddFuncDef =
    {"s7plcApp_registerRecordDeviceDriver", 1, rrddArgs};
static void rrddCallFunc(const iocshArgBuf *)
{
    s7plcApp_registerRecordDeviceDriver(*iocshPpdbbase);
}
